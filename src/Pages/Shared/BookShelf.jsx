      ...
      <div className="flex pt-10 flex-col sm:flex-row sm:items-center gap-4 mb-6">
        ...
        <div className="relative w-full sm:max-w-md">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border dark:bg-gray-100 border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition duration-200"
            value={searchTerm}
        ...
        {/* Dropdown Filter */}
        <select
          className="border dark:bg-gray-100 border-gray-300 rounded-lg px-4 py-2 shadow-sm focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition duration-200"
          value={readingStatus}
